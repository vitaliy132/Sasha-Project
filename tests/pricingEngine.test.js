...
describe("validateUnit() - Unit Type & Model Validation", () => {
  it("valid class_c model: mercedes_2021_2023", () => {
    const pricing = validateUnit("class_c", "mercedes_2021_2023");
    assert.ok(pricing);
...
describe("calculatePrice() - Full Pricing Workflow", () => {
  ...
  it("RETURN FORMAT: includes all required fields", () => {
    ...
    assert.strictEqual(result.unitModel, "mercedes_2021_2023");
